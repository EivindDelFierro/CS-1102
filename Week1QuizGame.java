...
public class Week1QuizGame {
  ...
  public static void main(String[] args) {
    ...
    final String[] QUESTION_1 = { "What is the national dish of England?", "A",
        "A. Tikka Masala, B. Ham and Cheese, C. Fish and Chips, D. Butter Chicken" };
    final String[] QUESTION_2 = { "What is the most populous country on Earth?", "C",
        "A. Indonesia, B. China, C. India, D. United States" };
    final String[] QUESTION_3 = { "How many toes do cats have on their back paws?", "D",
        "A. Five, B. Three, C. Six, D. Four" };
    final String[] QUESTION_4 = { "What war led to the death by guillotine of Marie Antoinette?", "A",
        "A. The French Revolution, B. War of the First Coalition, C. Irish Rebellion, D. War of the Second Coalition" };
    final String[] QUESTION_5 = { "What is the national animal of Scotland?", "B",
